...
SECRET_KEY = '8ys^q-p8_4p=tzac%4*h@7!+kk9gg1+7_b7_n54ytycj_ls0x('
...
with open(os.path.join(BASE_DIR, 'config.json'), 'r') as rf:
...
django_static_path = os.path.join(BASE_DIR, 'django_static')


STATICFILES_DIRS = []

for chk_path in [os.path.join(REACT_HOME, 'static'), django_static_path]:
    if os.path.exists(chk_path):
        STATICFILES_DIRS.append(chk_path)
